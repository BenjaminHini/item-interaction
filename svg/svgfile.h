...
class Svgfile
{
    public:
        ...
        void addTriangle(double x1, double y1, double x2, double y2, std::string colorFill,
                          double thickness, std::string colorStroke);
        void addTriangle(double x1, double y1, double x2, double y2,std::string colorFill=defcol);
        void addLine(double x1, double y1, double x2, double y2, std::string color=defcol);
        void addCross(double x, double y, double span, std::string color=defcol);
        void addRectangle(double, double, double, double,Coords, std::string color=defcol, double inclinaison=0);
